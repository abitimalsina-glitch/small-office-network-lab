...
### Same-VLAN Ping Test
Success within the same broadcast domain.
![Same VLAN Ping](../screenshots/same-vlan-ping-test.png)

### Different-VLAN Ping Test (Inter-VLAN)
Successful communication between different departments via the router.
...
*Figure 6: Successful DHCP lease for a client in the Reception VLAN.*

### Wireless Client IP Configuration
![IP Config VLAN 50](../screenshots/ip-config-vlan50.png)
*Figure 7: Successful DHCP lease for a wireless client on the Guest network.*