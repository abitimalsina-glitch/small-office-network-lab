...
*Figure 3: Configuration of the trunk link on the switch.*
...
*Figure 4: Active DHCP bindings showing leased IP addresses to clients.*
...
*Figure 5a: PC in VLAN 10 successfully receiving an IP address from the DHCP pool.*

![IP Config VLAN 20](../screenshots/ip-config-vlan20.png)
*Figure 5b: PC in VLAN 20 successfully receiving an IP address from the Finance DHCP pool.*
